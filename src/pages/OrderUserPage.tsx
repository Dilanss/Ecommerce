    ...
    return (
        <div>
                        ...
                        {order.orderItems.map((product, index) => (
                            <tr key={index} className='border-b border-gray-200'>
                                <td className='p-4 font-medium tracking-tighter flex gap-3 items-center'>
                                    <img src={product.productImage} alt={product.productName} className='h-20 w-20m object-contain rounded-lg'/>
                                ...
                                <td className='p-4 font-medium tracking-tighter items-center'>
                                    {product.quantity}
                                </td>
            ...
            <div className='flex flex-col gap-3'>
                ...
                <div className='border border-tone-300 p-5 flex flex-col gap-5'>
